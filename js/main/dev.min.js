...
$(this).attr("edgename");edge_id=outgoingEdges.filter('[name="'+name+'"]').data("id");console.log("Button name is: ",name);console.log("Edge is: ",edge_id);var a=getIndexFromOutgoingEdges(edge_id,outgoingEdges);console.log("Index is: ",a);progressStory(a)})});var k=new function(){this.init=function(){$("body").append('<div id="player-inventory-modal" class="modal" style="height: 90%"> <div style="height: 90%" class="modal-content"> <h4>Your Inventory</h4> <div class="row max-height scroll-y"> <ul id="player-items-list" class="collapsible"  data-collapsible="expandable"></ul> </div></div></div>')};
this.appendItems=function(){for(var a in project_project.gameInventory){var b=project_project.gameInventory[a];$("#player-items-list").empty();if(0<b.playCount){$("#player-items-list").append('<li><div class="collapsible-header"><span class="'+a+'-name">'+b.name+'</span></div><div class="collapsible-body"><div class="row pos-relative "><div class="col m6"><h6><i class="material-icons small">subject</i>Description: </h6><hr/><p class="'+a+'-description">'+b.description+'</p></div><div class="col m6"><h6><i class="material-icons small">stars</i>Modifiers: </h6><hr/> <div class="'+
a+'-modifiers-list"></div> </div> </div><hr/><div class="row" style="margin-bottom: 5px"><div class="col m4"> Item Count: <span style="font-weight: bold">'+b.playCount+"</span></div></div></div></li>");var b=$("."+a+"-modifiers-list"),c={},d;for(d in project_project.gameInventory[a].modifiers)c=project_project.gameInventory[a].modifiers[d],b.append('<div class="chip">'+gameAttributes_find(c.attributePath).name+"+"+c.modifierValue+"</div>")}}$("#player-items-list").collapsible({accordion:!1})};this.openInventory=
function(){$("#player-inventory-modal").openModal({dismissible:!0,ready:function(){},complete:function(){$("#player-items-list").empty()}})}};k.init();$(".playpage").find("div[class^='inventory']").each(function(a){$(this).click(function(){console.log("Open inventory");k.appendItems();k.openInventory()})});$(".playpage").find("div[class^='character']").each(function(a){$(this).click(function(){console.log("Open Character Sheet")})});$(".playpage").find("div[class^='jump']").each(function(a){$(this).click(function(){button_name=
$(this).attr("jumpnode");console.log("Button name is: ",button_name);jump_node=cy.$('.jump[button ="'+button_name+'"]')[0];console.log("Jump node is: ",jump_node);void 0===jump_node?console.log("Jump_node is undefined?"):(jump_node.data("origin",currentNode),currentNode=runJumpNode(jump_node),console.log("We jumped!"),parseNode())})});$(".playpage").find("div[class^='jumpback']").each(function(a){$(this).click(function(){console.log("Go back from jump node");currentNode=runJumpEnd(currentNode);parseNode()})});
$(".playpage .handlecontainer").hide();$(".playpage").children().removeClass("resize-element");$(".playpage").children().removeClass("resize-child");$(".playpage").children().children().removeClass("resize-element");$(".playpage").children().attr("contenteditable","false");$(".playpage").children().children().attr("contenteditable","false")}function progressStoryViaButton(a){}
