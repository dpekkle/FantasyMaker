...
function resizeCanvas(){var a=$(window).width(),b=$(window).height(),c=$("#tabheadings").height()+$(".nav-wrapper").height();$("#cy").css("height",b-c);console.log("We resized, width: "+a+" height: "+b);cy.resize();resizePageContainerDiv()}$(window).resize(resizeCanvas);
