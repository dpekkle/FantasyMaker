...
"_"+e.id+"_specValue_s2_2_inputField").val())):0<$("#newCondition_"+d+"_randValue_s2_2").length&&$("#newCondition_"+d+"_randValue_s2_2").attr("id","exCondition_"+e.edge+"_"+e.id+"_randValue_s2_2"),0<$("#newCondition_"+d+"_invButton").length&&($("#newCondition_"+d+"_invButton").attr("id","exCondition_"+e.edge+"_"+e.id+"_invButton"),$("#newCondition_"+d+"_existsButton").attr("id","exCondition_"+e.edge+"_"+e.id+"_existsButton")),e.html=$("#exCondition_"+e.edge+"_"+e.id).html(),void 0!==e&&c.data.conditions.push(e));
for(d=0;d<edgeOverlay_newOutcomeCount;d++)0<$("#newOutcome_"+d).length&&(e=conditions_createOutcome(c,null),$("#newOutcome_"+d+"_settings").attr("id","exOutcome_"+e.edge+"_"+e.id+"_settings"),$("#newOutcome_"+d).attr("id","exOutcome_"+e.edge+"_"+e.id),$("#newOutcome_"+d+"_attButton_1").attr("id","exOutcome_"+e.edge+"_"+e.id+"_attButton_1"),$("#newOutcome_"+d+"_compMenu").attr("id","exOutcome_"+e.edge+"_"+e.id+"_compMenu"),$("#newOutcome_"+d+"_attButton_2").attr("id","exOutcome_"+e.edge+"_"+e.id+"_attButton_2"),
$("#newOutcome_"+d+"_specValue_2").attr("id","exOutcome_"+e.edge+"_"+e.id+"_specValue_2"),$("#newOutcome_"+d+"_specValue_2_inputField").attr("id","exOutcome_"+e.edge+"_"+e.id+"_specValue_2_inputField"),$("#exOutcome_"+e.edge+"_"+e.id+"_specValue_2_inputField").attr("value",$("#exOutcome_"+e.edge+"_"+e.id+"_specValue_2_inputField").val()),$("#newOutcome_"+d+"_randValue_2").attr("id","exOutcome_"+e.edge+"_"+e.id+"_randValue_2"),$("#newOutcome_"+d+"_text_1").attr("id","exOutcome_"+e.edge+"_"+e.id+"_text_1"),
$("#newOutcome_"+d+"_text_2").attr("id","exOutcome_"+e.edge+"_"+e.id+"_text_2"),e.html=$("#exOutcome_"+e.edge+"_"+e.id).html(),void 0!==e&&c.data.outcomes.push(e))}edgeOverlay_newOutcomeCount=edgeOverlay_newConditionCount=0}function edgeOverlay_addNewCondition(a){var b="newCondition_"+edgeOverlay_newConditionCount,c=generateCondition_type1(b);$("#"+a).append(c);initAttributeButton(b+"_attButton_s1_1");initAttributeButton(b+"_attButton_s1_2");edgeOverlay_newConditionCount++}
...
$("#"+c+"_attButton_s2_1").tooltip({delay:50});$("#"+c+"_attButton_s2_2").tooltip({delay:50});$("#"+c+"_randValue_s1_2").tooltip({delay:50});$("#"+c+"_randValue_s2_1").tooltip({delay:50});$("#"+c+"_randValue_s2_2").tooltip({delay:50});$("#"+c+"_invButton").tooltip({delay:50});$("#"+c).hide(0,function(){$("#"+c).show(300)})}
...
function attributeSelected(a,b,c){var d=b.split("_"),e;"newCondition"===d[0]?(e=d[0]+"_"+d[1]+"_attButton_"+d[3]+"_"+d[4],newButton=generateAttributeButton(e,"game-attributes numbers","NO_COL"),$("#"+d[0]+"_"+d[1]+"_"+d[2]+"_"+d[3]+"_"+d[4]).replaceWith(newButton)):"exCondition"===d[0]?(e=d[0]+"_"+d[1]+"_"+d[2]+"_attButton_"+d[4]+"_"+d[5],newButton=generateAttributeButton(e,"game-attributes numbers","NO_COL"),$("#"+d[0]+"_"+d[1]+"_"+d[2]+"_"+d[3]+"_"+d[4]+"_"+d[5]).replaceWith(newButton)):"newOutcome"===
d[0]?(e=d[0]+"_"+d[1]+"_attButton_"+d[3],newButton=generateAttributeButton(e,"game-attributes numbers","NO_COL"),$("#"+d[0]+"_"+d[1]+"_"+d[2]+"_"+d[3]).replaceWith(newButton)):"exOutcome"===d[0]?(e=d[0]+"_"+d[1]+"_"+d[2]+"_attButton_"+d[4],newButton=generateAttributeButton(e,"game-attributes numbers","NO_COL"),$("#"+d[0]+"_"+d[1]+"_"+d[2]+"_"+d[3]+"_"+d[4]).replaceWith(newButton)):"inventoryItem"==d[0]&&(e=b);console.log(e+" "+c.path);$("#"+e).text(a);$("#"+e).attr("path",c.path);updateTooltip(e,
c.path)}
...
"game-attributes numbers")+'</div><div class="divider"></div></li>'}function generateInventoryCondition(a){return"<li id="+a+'><div class="row" type="4">'+generateSettingsButton(a)+generateInventoryButton(a+"_invButton")+generateExistsButton(a+"_existsButton")+'</div><div class="divider"></div></li>'}
function generateOutcome(a){return"<li id="+a+'><div class="row" type="Attribute Modification">'+generateSettingsButton(a)+generateAttributeButton(a+"_attButton_1","game-attributes")+generateComparisonButon(a+"_compMenu","mods","+")+generateAttributeButton(a+"_attButton_2","game-attributes numbers")+'</div><div class="divider"></div></li>'}
...
function generic_generateAttributeButton(a,b,c){return'<div id="'+a+'" class="condition-context-menu '+b+' attribute-button tooltipped" data-html="true" data-position="bottom" data-delay="50" data-tooltip=""></div>'}function generateComparisonButon(a,b,c){return'<div id="'+a+'" class="col s1 comparison-context-menu '+b+' comparison-button">'+c+"</div>"}
...
function generateInventoryButton(a){return'<div class="col s2 truncate"><div id="'+a+'" class="attribute-button tooltipped inventory-context-menu" data-html="true" data-position="bottom" data-delay="50" data-tooltip="" itemid="" ><p class="truncate">.....</p></div></div>'}function setInventoryButtonSelection(a,b){$("#"+a).children().text(b.name);$("#"+a).attr("data-tooltip",b.name);$("#"+a).attr("itemid",b.itemID);$("#"+a).tooltip({delay:50})}
function generateExistsButton(a){return'<div class="col s2 truncate"><a href="#" ><div id="'+a+'" state="false" onclick=existsButtonSwapState(this.id) class="attribute-button"><p class="truncate">Not in inventory</p></div></a></div>'}function existsButtonSwapState(a){"false"===$("#"+a).attr("state")?($("#"+a).children().text("Is in inventory"),$("#"+a).attr("state","true")):($("#"+a).children().text("Not in inventory"),$("#"+a).attr("state","false"))}
...
case "type3":d=generateCondition_type3(b);$("#"+b).replaceWith(d);initAttributeButton(b+"_attButton_s1_1");initAttributeButton(b+"_attButton_s1_2");initAttributeButton(b+"_attButton_s2_1");initAttributeButton(b+"_attButton_s2_2");break;case "type4":d=generateInventoryCondition(b),$("#"+b).replaceWith(d)}}
...
$.contextMenu({selector:".inventory-context-menu",trigger:"left",build:function(a){var b={items:{}};b.items.inventory={name:"Inventory Item",items:{}};if(0<Object.keys(project_project.gameInventory).length)for(var c in project_project.gameInventory){var d=gameInventory_getItem(c);b.items.inventory.items[c]={name:d.name,callback:function(b,c){setInventoryButtonSelection(a.attr("id"),d)}}}else b.items.err={name:"No inventory items available",disabled:!0};return b}});var gameAttributes={};function GameAttribute(a,b,c,d,e,f,g,h){this.name=c;this.is_leaf=e;this.value=f;this.maxValue=h;this.minValue=g;this.parentPath=a;this.id=d;null!=a?(this.level=b+1,this.path=a+"_"+d):(this.path=d,this.level=0);this.childrenArray=[]}function gameAttributes_addAttribute(a,b,c,d,e){gameAttributes_addChild(a,b,!0,c,d,e)}function gameAttributes_addAttributeFolder(a,b){gameAttributes_addChild(a,b,!1)}
...
function DefineItemModal(){this.isNewItem=this.confirm=!1;this.currentItemID=null;this.modifierCount=0;this.init=function(){$("body").append('<div id="define-item-modal" class=" modal modal-fixed-footer"><div class="modal-content"><div class="row row-centered"><h3>Define Item</h3><div class="input-field col m6"><input id="item-name-input" type="text"/><label for="item-name-input" type="text">Item Name</label></div><div class="input-field col m2 offset-m4"><input id="item-initCount-input" value="0" type="number"/><label for="item-initCount-input">Initial Item Count</label></div><div class="input-field col m6"><textarea id="item-detail-input" class="materialize-textarea"></textarea><label for="item-detail-input">Item Description</label></div><button class="col m4 offset-m2 btn tooltiped" data-tooltip="Modifiers will modify attributes when they are in a players inventory" onclick="defineItemModal.addModifierInput(true);" style="margin-top: 75px;">Add Attribute Modifier</button></div><div class="row row-centered"><ul class="item-modifiers-input-list"></ul></div></div><div class="modal-footer"><a href="#!" class=" modal-action modal-close waves-effect waves-red btn-flat" onclick="defineItemModal.evaluateModal(false)">Cancel</a><a href="#!" class=" modal-action waves-effect waves-green btn-flat" onclick="defineItemModal.evaluateModal(true)">Confirm</a></div></div>')};this.prompt=
function(a,b){var c=$("#item-name-input"),d=$("#item-detail-input"),e=$("#item-initCount-input"),f=null;this.currentItemID=a;this.isNewItem=b;this.modifierCount=0;$("#item-modifiers-input-list").empty();if(!this.isNewItem){f=project_project.gameInventory[a];c.val(f.name);d.val(f.description);d.trigger("autoresize");e.val(f.initCount);for(var g in project_project.gameInventory[a].modifiers)this.addModifierInput(!1,g,project_project.gameInventory[a].modifiers[g])}$("#define-item-modal").openModal()};
this.evaluateModal=function(a){var b=$("#item-name-input"),c=$("#item-detail-input"),d=$("#item-initCount-input"),e=$(".item-modifiers-input-list");a?(a=!1,void 0!=b.val()&&""!=b.val()&&(a=!0),a?(a={name:b.val(),description:c.val(),initCount:d.val(),modifiers:this.evaluateModifiers()},this.isNewItem?(project_project.gameInventory[this.currentItemID]=new InventoryItem(a),gameInventory_createModule_appendItemDiv(this.currentItemID,project_project.gameInventory[this.currentItemID])):(project_project.gameInventory[this.currentItemID]=
a,gameInventory_createModule_updateItemHtml(this.currentItemID)),void 0!=c.val()&&""!=c.val()||c.val("No description provided"),$("#define-item-modal").closeModal(),b.val(""),c.val(""),d.val("0"),e.empty()):(console.log("item definition validation failed"),Materialize.toast("Please provide an item name",3E3,"rounded","dismissible"))):($("#define-item-modal").closeModal(),b.val(""),c.val(""),d.val("0"),e.empty())};this.addModifierInput=function(a,b,c){b=a?"modifier-"+generateID():b;var d="<li id=inventoryItemModifierRow_"+
b+'><div class="row">'+generic_generateAttributeButton(b+"-modifyAttributeInput","game-attributes")+'<div class="input-field col m2"><select id="'+b+'-modifyOperationInput"><option value="+">+ (Add To)</option><option value="-">- (Subtract From)</option></select><label>Modify Operation</label> </div><div class="input-field col m2"><input id="'+b+'-modifyAmountInput" type="number"/><label>Modify Amount</label></div><div class="col m1"><button class="btn-floating red offset-m2" style="margin-top: 20px;" onclick="defineItemModal.removeModifierInput(\''+
...
function(a){gameInventory_deleteModifier(this.currentItemID,a);$("#inventoryItemModifierRow_"+a).remove();this.modifierCount--};this.evaluateModifiers=function(){var a=[],b={};$(".item-modifiers-input-list").children().each(function(){a.push($(this).attr("id").split("_")[1])});for(var c=0;c<a.length;c++){var d=a[c],e=$("#"+d+"-modifyAttributeInput").attr("path"),f=$("#"+d+"-modifyOperationInput").val(),g=$("#"+d+"-modifyAmountInput").val();"-"===f&&(g*=-1);b[d]={attributePath:e,modifierValue:g}}return b}}
var defineItemModal=new DefineItemModal;defineItemModal.init();var genericComparisonRow={};function generic_example(){generic_addRow("row_1_","your-settings-menu","exampleList")}function generic_addRow(a,b,c){$("#"+c).append(generic_generateRow(a,b));initAttributeButton(a+"attButton1");initAttributeButton(a+"attbutton2")}$.contextMenu({selector:".your-settings-menu",trigger:"left",build:function(a){a={items:{}};a.items.dosomething={name:"do something",callback:function(a,c){alert("Done something")}};return a}});
function generic_generateRow(a,b){return"<li id="+a+'><div class="row" type="1">'+generic_yourSettingsButton(a,b)+generic_generateAttributeButton(a+"attButton1","game-attributes")+generateComparisonButon(a+"_compMenu","comps","=")+generic_generateAttributeButton(a+"attbutton2","game-attributes numbers")+'</div><div class="divider"></div></li>'}
...
"("+b+") "+f+" "+getAttributeText(a[0].childNodes[3].childNodes[0])+"("+d+") "+c+" "+getAttributeText(a[0].childNodes[5].childNodes[0])+"("+h+")"+l+" "+getAttributeText(a[0].childNodes[7].childNodes[0])+"("+k+") is "+boolToString(e)+"<br>");return e}if("4"===b){b=gameInventory_getItem(a[0].childNodes[1].childNodes[0].attributes.itemid.value);if("true"===a[0].childNodes[2].childNodes[0].firstChild.attributes.state.value){if(0<b.playCount)return!0}else if(0===b.playCount)return!0;return!1}}
...
a+")"});$(".playpage").css({"-webkit-transform":"scale("+a+")"})}$(window).resize(resizePlayPage);console.log("Enter main.js version 0.5.0");$(document).ready();$("select").material_select();var testgraph={};function testJumpNodes(){cy.$(".jumpend").each(function(a,b){var c=b.predecessors("node").roots();for(a=0;a<c.size();a++)c[a].hasClass("jump")||(console.log("bad one found",c[a].data("name")),c[a].flashClass("jumpenderror",3E3),b.flashClass("jumpenderror",3E3))});return found}
function checkValidGraph(){var a="";1>cy.$("*").length&&(a=a.concat("The graph is empty\n"));cy.$(".start").hasClass("page")||(a=a.concat("Starting class must be a page node\n"));testConnectivity()||(a=a.concat("Graph is NOT connected\n"));testJumpNodes()||(a=a.concat("Jump End nodes can be reached without arriving from a jump start!\n"));""==a?alert("All tests passed"):alert(a)}
...
setTimeout(function(){d.removeClass("disconnected")},3E3);return 0==d.size()};var tests={};
