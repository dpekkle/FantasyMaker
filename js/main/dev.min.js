...
function chooseJump(a){console.log("Choose jump mode:",a);$(".jumpmode").addClass("activebutton");"Start"==a?(current_state=states.NEWJUMP,console.log("Set state to:",current_state)):"End"==a&&(current_state=states.NEWJUMPEND,console.log("Set state to:",current_state))};var tutorial={},tutorial_graph=null,tutorial_objects=[{message:"First click Page Node and select 'Default'",css:function(){$(".pagemode").addClass("tutorial-button-highlight")},condition:function(){console.log("First function");return current_state==states.NEWPAGE?(console.log("First function done"),!0):!1}},{message:"Now tap on the screen on the left to create a Page",css:function(){$(".pagemode").removeClass("tutorial-button-highlight");$("#cy").addClass("tutorial-button-highlight")},condition:function(){return 0!==
cy.elements().size()?!0:!1}},{message:"That box you just created is a new Page!",css:function(){$("#cy").removeClass("tutorial-button-highlight")}},{message:"Try adding some more Pages",css:function(){},condition:function(){return 2<cy.elements().size()?!0:!1}},{message:"The green Page marks the starting Page."},{message:"You can drag and drop these Page nodes around, or tap to select them.",condition:function(){return 8<tutorial_timer?!0:!1}},{message:"Now lets try connecting some Pages.",css:function(){$(".connectionmode").addClass("tutorial-button-highlight")}},
{message:"Click the Path button.",css:function(){$(".connectionmode").show()},condition:function(){return current_state==states.CONNECTING?!0:!1}},{message:"Now tap one of the Pages you added.",condition:function(){return null!==source_node?!0:!1}},{message:"The blue border indicates the 'source' of the Path"},{message:"Now tap a different Page node.",condition:function(){return 0!==cy.edges().size()?(cy.edges(),!0):!1}},{message:"Nice! You've now connected two Pages"},{message:"Try making another Path",
condition:function(){return 1<cy.edges().size()?!0:!1}},{message:"The labels on each Path help you keep track of them"},{message:"Leave Path mode by pressing escape or the Path button again",condition:function(){return current_state!==states.CONNECTING?!0:!1}},{message:"Now lets see what Paths look like in your Page",css:function(){$(".connectionmode").removeClass("tutorial-button-highlight")}},{message:"Select any 'source' Page with a Path by tapping it.",css:function(){},condition:function(){return 0<
cy.$(":selected").outgoers().edges().size()?!0:!1}},{message:"Now press 'Edit Page' to open up the Page Designer",css:function(){$('.editbutton[data-target="page-modal"').addClass("tutorial-button-highlight")},condition:function(){return"none"!==$("#page-modal").css("display")?!0:!1}},{message:"Here you can design the appearance of the Page, you can see the Paths that you just created",css:function(){$('.editbutton[data-target="page-modal"').removeClass("tutorial-button-highlight")}},{message:"You can position them however you want by dragging the handle on top of them."},
{message:"Try adding a text box, just click the button",css:function(){$('[onclick="addTextContainer()"]').addClass("tutorial-button-highlight")},condition:function(){return 0!==$(".text-container").size()?!0:!1}},{message:"You can edit the contents of a text box by clicking the box and typing",css:function(){$('[onclick="addTextContainer()"]').removeClass("tutorial-button-highlight")},condition:function(){return 8<tutorial_timer?!0:!1}},{message:"To edit the style try click on it's setting icon",
css:function(){$('[onclick="addTextContainer()"]').removeClass("tutorial-button-highlight")},condition:function(){return 8<tutorial_timer?!0:!1}},{message:"You can also edit the entire Page's style by clicking on the blue settings icon",css:function(){$('[onclick="addTextContainer()"]').removeClass("tutorial-button-highlight")}},{message:"When you're done you can exit by pressing escape or the X icon.",css:function(){$(".fa-times").addClass("tutorial-button-highlight")},condition:function(){return"none"==
$("#page-modal").css("display")?!0:!1}},{message:"Now lets try running your project, click on the Play button",css:function(){$(".fa-times").removeClass("tutorial-button-highlight");$(".playgamebutton ").addClass("tutorial-button-highlight")},condition:function(){return"none"==$("#Play").css("display")?!0:!1}},{message:"",css:function(){$(".playgamebutton").removeClass("tutorial-button-highlight")},condition:function(){return"none"==$("#Play").css("display")?!0:!1}},{message:"",css:function(){finishTutorial();
continueTutorial()}}];function checkInTutorial(){return"yoqpzHbHLaxCX__PcdHp"==project_project.projectName&&window.location.href!==host_playModule()?(console.log(window.location.href),myModal.prompt("Welcome!","Welcome to FantasyMaker. This tutorial will give you a quick understanding of how to use the system to create things like games, stories, and presentations. Confirm to proceed, or cancel to load a demo project.",[],function(){prepareTutorial()}),!0):!1}
function prepareTutorial(){progress=!1;tutorial_timer=toast_id=0;tutorial_graph=cy.elements().clone();cy.remove(cy.elements());console.log("Cloning tutorial graph ",tutorial_graph);$("#sidebar .btn").hide();$("#sidebar hr").hide();$("#sidebar .pagemode").show();runTutorial()}
function runTutorial(){createToast(tutorial_objects[toast_id].message,toast_id);void 0!==tutorial_objects[toast_id].css&&tutorial_objects[toast_id].css();refreshIntervalId=setInterval(function(){"none"==$("#projects").css("display")&&(tutorial_timer+=.5);toast_id>tutorial_objects.length-1?(hideToast(toast_id),console.log("Clear the interval"),clearInterval(window.refreshIntervalId)):(void 0===tutorial_objects[toast_id].condition?4<tutorial_timer&&(console.log("tutorial timer ready: ",tutorial_timer),
progress=!0):tutorial_objects[toast_id].condition()&&(console.log("tutorial condition met"),progress=!0),progress&&(tutorial_timer=0,console.log("Lets progress the toast"),progress=!1,hideToast(toast_id),toast_id++,createToast(tutorial_objects[toast_id].message,toast_id),void 0!==tutorial_objects[toast_id].css&&tutorial_objects[toast_id].css()))},500)}function finishTutorial(){$("#sidebar .btn").show();$("#sidebar hr").show()}
function continueTutorial(){myModal.prompt("Congratulations!","You are now ready to start exploring more advanced options.",[],function(){cy.remove(cy.elements());cy.add(tutorial_graph);createToast("The wiki has just been loaded. Click on the Play Game button to try it.");$(".playgamebutton").addClass("tutorial-button-highlight")})}function createToast(a,b){Materialize.toast(a,2E5,"toast"+b)}function hideToast(a){$(".toast"+a).fadeOut()};var initCanvas={};console.log("Enter initCanvas.js");var cytoscape_headless,cytoscape_container;window.location.href!==host_play()?(cytoscape_headless=!1,cytoscape_container=document.getElementById("cy")):(cytoscape_headless=!0,cytoscape_container=null);
