...
;var states={DEFAULT:0,CONNECTING:1,NEWPAGE:2,NEWCONTROL:3,NEWJUMP:4,NEWJUMPEND:5,NEWEMPTY:6,NEWFIGHT:7};current_state=states.DEFAULT;function defaultState(){exitStates();current_state=states.DEFAULT}function exitStates(){current_state==states.CONNECTING&&(cy.boxSelectionEnabled(!0),null!==source_node&&(source_node.removeClass("source_node"),source_node=null));$("#sidebar .btn").removeClass("activebutton");$(".pagemode").html("Page Node");cy.$(":parent").selectify()}
...
fight_attributes=eval({"39BX":{name:"Character",is_leaf:!1,parentPath:null,id:"39BX",path:"39BX",level:0,childrenArray:["GWed","6a4t"],GWed:{name:"Health",is_leaf:!0,value:"100",initValue:"100",parentPath:"39BX",id:"GWed",description:"No description provided",level:null,path:"39BX_GWed",childrenArray:[]},"6a4t":{name:"Damage",is_leaf:!0,value:"10",initValue:"10",parentPath:"39BX",id:"6a4t",description:"No description provided",level:null,path:"39BX_6a4t",childrenArray:[]}},xmHw:{name:"Enemies",is_leaf:!1,
parentPath:null,id:"xmHw",path:"xmHw",level:0,childrenArray:["0BPX"],"0BPX":{name:"Crab",is_leaf:!1,parentPath:"xmHw",id:"0BPX",level:null,path:"xmHw_0BPX",childrenArray:["ABRt","wIat"],ABRt:{name:"Health",is_leaf:!0,value:"50",initValue:"50",parentPath:"xmHw_0BPX",id:"ABRt",description:"No description provided",level:null,path:"xmHw_0BPX_ABRt",childrenArray:[]},wIat:{name:"Damage",is_leaf:!0,value:"10",initValue:"10",parentPath:"xmHw_0BPX",id:"wIat",description:"No description provided",level:null,
path:"xmHw_0BPX_wIat",childrenArray:[]}}}});cy.on("tapstart","node",function(a){held_node=a.cyTarget});
...
function createFight(a){var b=cy.$(".start");console.log(a.cyRenderedPosition);var c=cy.add(fight_objects),d=cy.collection(c);$.each(d.nodes(),function(b,c){if(0<b&&void 0!==this.data("displacement")){var e=this.data("displacement").x,k=this.data("displacement").y;console.log(e);console.log(k);d[b].stop(!1,!0);d[b].animate({position:{x:a.cyPosition.x+e,y:a.cyPosition.y+k}},{duration:500})}});for(var e in fight_attributes)project_project.gameAttributes[e]=fight_attributes[e];setStart(b);cy.getElementById("72e94087-01f9-477d-941c-3fb29652b431").select()}
