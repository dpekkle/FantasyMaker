...
function openEditControlOverlay(a){var b=a;null===a&&(b=cy.$(":selected")[0]);$("#controlcontainers #controltext").val(escapeHtml(b.data("text")));populateControlOverlay(b)}function openEditJumpOverlay(a){var b=a;null===a&&(b=cy.$(":selected")[0]);populateJumpOverlay(b)}function openAttributesOverlay(){$("#attributes-modal").openModal({dismissible:!0,ready:function(){},complete:function(){}})}
