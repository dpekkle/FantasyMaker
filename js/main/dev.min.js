...
c||void 0===e||void 0===g){console.log("executeOutcomes() attribute modification: attButton1, attButton2, or path is undefined");break}g=gameAttributes_find(g);f>g.maxValue?(logger.log("Arrtibute "+getAttributeText(b[0].childNodes[1].childNodes[0])+" has reached its maximum value.<br>"),g.value=g.maxValue):f<g.minValue?(logger.log("Arrtibute "+getAttributeText(b[0].childNodes[1].childNodes[0])+" has reached its minimum value.<br>"),g.value=g.minValue):g.value=f;logger.log("Outcome: "+getAttributeText(b[0].childNodes[1].childNodes[0])+
"("+c+") "+d+" "+getAttributeText(b[0].childNodes[3].childNodes[0])+"("+e+") <br>");logger.log("Attribute "+getAttributeText(b[0].childNodes[1].childNodes[0])+" was modified to "+g.value+"<br>")}else if("Text-Attribute-Text"===c)console.log("TEXT ATT TEXT:"),console.log("ONE: "+getTextButtonValue(b[0].childNodes[1].childNodes[0])),console.log("TWO: "+getTextButtonValue(b[0].childNodes[3].childNodes[0])),d=getTextButtonValue(b[0].childNodes[1].childNodes[0]),c=getAttributeValue(b[0].childNodes[2].childNodes[0]),
b=getTextButtonValue(b[0].childNodes[3].childNodes[0]),void 0===c&&(console.log("executeOutcomes() attribute modification: attButton1 or attButton2 is undefined"),c=" <Error: No attribute selected> "),logger.playerLog(d+c+b);else if("Text-InvItem-Text"===c)console.log("TEXT ATT TEXT:"),console.log("ONE: "+getTextButtonValue(b[0].childNodes[1].childNodes[0])),console.log("TWO: "+getTextButtonValue(b[0].childNodes[3].childNodes[0])),d=getTextButtonValue(b[0].childNodes[1].childNodes[0]),c=getInventoryItemFromHtml(b[0].childNodes[2].childNodes[0]),
b=getTextButtonValue(b[0].childNodes[3].childNodes[0]),e="",void 0!==c?e=c.playCount:console.log("executeOutcomes() inventory Text-InvItem-Text: item is undefined."),logger.playerLog(d+e+b);else if("Text"===c)d=getTextButtonValue(b[0].childNodes[1].childNodes[0]),logger.playerLog(d);else if("inventory_addRemove"===c){console.log(b);e=getAddRemoveButtonState(b[0].childNodes[1].childNodes[0]);d=getAttributeValue(b[0].childNodes[2].childNodes[0]);c=getInventoryItemFromHtml(b[0].childNodes[3].childNodes[0]);
if(void 0===c){console.log("executeOutcomes() inventory add/remove: item is undefined.");break}else if(isNaN(d)){console.log("executeOutcomes() inventory add/remove: inputFieldValue is not a number.");break}"add"===e?(b=parseInt(c.playCount),b+=d,c.playCount=b):"remove"===e&&(b=parseInt(c.playCount),b-=d,c.playCount=0>b?0:b)}}else logger.log("Edge "+a.json().data.name+" has no outcomes.<br>")}function getTextButtonValue(a){return a.attributes["data-tooltip"].value}
function getAddRemoveButtonState(a){return a.childNodes[0].attributes.state.value}
