...
function projectSettings_generateProjectCard(a){return'<li><div class="col s1"><p></p></div><div class="card hoverable col s4" style="height: 200px;"><div class="card-content"><span class="card-title activator grey-text text-darken-4 truncate" style="position: relative;">'+a.title+'<i class="material-icons right">more_vert</i></span><div class="row"><p>Title: '+a.title+'</p></div><div class="row"><p>Author: '+a.author+'</p></div><div class="row" ><a href="#" class="btn col s8 offset-s2" onclick=projectSettings_prepThenNavToMain(\''+
a.projName+'\')>Load</a></div></div><div class="card-reveal" ><span class="card-title grey-text text-darken-4">'+a.title+'<i class="material-icons right">close</i></span><p>Date Created: '+a.dateCreated+"</p><p>Last Modified: "+a.lastModified+"</p>"+(!0===a.published?'<div id="'+a.projName+'_pub"><p style="color: green;">Published</p><p>Link to play game:<span><a href="'+a.gameLink+'" target="_blank">'+a.gameLink+"</a></span></p></div>":'<p id="'+a.projName+'_pub" class="pubTT tooltipped" data-position="bottom" data-delay="50" data-tooltip="Load your project and view the settings tab to publish your project for the world to see!" style="color: red;">Project is not published</p>')+
'<a class="btn-floating btn-small waves-effect waves-light red" onclick=projectSettings_deleteProject(\''+users_getUsername()+"','"+a.projName+"','"+project_project.projectName+'\')><i class="small material-icons">delete</i></a></div></div></li>'}
...
function dragMoveListener(a){var b=$("#pagecontainers")[0],c=b.getBoundingClientRect().width/b.offsetWidth,d=b.getBoundingClientRect().height/b.offsetHeight,b=a.target,c=(parseFloat(b.getAttribute("data-x"))||0)+a.dx/c;a=(parseFloat(b.getAttribute("data-y"))||0)+a.dy/d;b.style.webkitTransform=b.style.transform="translate("+c+"px, "+a+"px)";b.setAttribute("data-x",c);b.setAttribute("data-y",a)}window.dragMoveListener=dragMoveListener;var pageOverlay={},show_handles=!0;function updatePageStyle(a){openEditPageOverlay(a);closeOverlay(a)}function toggleHandles(){show_handles=!show_handles;$(".handlemode").toggleClass("activebutton");show_handles?($(".handlecontainer").show(),$(".handlemode").html("Handles: Shown")):($(".handlecontainer").hide(),$(".handlemode").html("Handles: Hidden"))}
