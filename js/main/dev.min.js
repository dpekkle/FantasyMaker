...
function openEditControlOverlay(a){var b=a;null===a&&(b=cy.$(":selected")[0]);$("#controlcontainers #controltext").val(escapeHtml(b.data("text")));populateControlOverlay(b)}function openEditJumpOverlay(a){var b=a;null===a&&(b=cy.$(":selected")[0]);populateJumpOverlay(b)}function openAttributesOverlay(){$("#attributes-modal").openModal({dismissible:!0,ready:function(){gameAttributes_createModule_recursiveListDisplayAll();$(".attributesButton").hide()},complete:function(){}})}
...
this.evaluateModal=function(a){if(a){a=!1;var b=!0,c=!0,d=!0;void 0!=this.nameInput.val()&&""!=this.nameInput.val()&&void 0!=this.initValueInput.val()&&""!=this.initValueInput.val()&&(a=!0);this.maxValueToggle.prop("checked")&&""==this.maxValueInput.val()&&(c=a=!1);this.minValueToggle.prop("checked")&&""==this.minValueInput.val()&&(b=a=!1);this.minValueToggle.prop("checked")&&this.maxValueToggle.prop("checked")&&this.minValueInput.val()>this.maxValueInput.val()&&(a=d=c=b=!1);if(this.minValueToggle.prop("checked")&&
this.minValueInput.val()>this.initValueInput.val()||this.maxValueToggle.prop("checked")&&this.maxValueInput.val()<this.initValueInput.val())a=d=!1;if(a)void 0!=this.detailInput.val()&&""!=this.detailInput.val()||this.detailInput.val("No description provided"),a={name:this.nameInput.val(),id:this.currentAttributeID,description:this.detailInput.val(),value:this.initValueInput.val(),parentPath:currentAttributeObj.path,is_leaf:!0},this.minValueToggle.prop("checked")?a.minValue=this.minValueInput.val():
a.minValue=void 0,this.maxValueToggle.prop("checked")?a.maxValue=this.maxValueInput.val():a.maxValue=void 0,this.isNewValue?(currentAttributeObj[this.currentAttributeID]=new GameAttribute(a),currentAttributeObj.childrenArray.push(this.currentAttributeID),gameAttributes_createModule_recursiveListDisplayAll()):currentAttributeObj[this.attributeObj.id]=new GameAttribute(a),gameAttributes_createModule_displayFolder(currentAttributeObj.path),$("#define-attribute-modal").closeModal(),this.nameInput.val(""),
this.detailInput.val(""),this.initValueInput.val("0"),this.minValueInput.val("0"),this.maxValueInput.val("0");else{console.log("value definition validation failed");if(void 0==this.nameInput.val()||""==this.nameInput.val())Materialize.toast("Please provide an attribute name",5E3,"rounded","dismissible"),this.nameInput.addClass("invalid");if(void 0==this.initValueInput.val()||""==this.initValueInput.val())Materialize.toast("Please provide an initial attribute value ",7E3,"rounded","dismissible"),this.initValueInput.addClass("invalid");
b||(Materialize.toast("Please provide a minimum value",7E3,"rounded","dismissible"),this.minValueInput.addClass("invalid"));c||(Materialize.toast("Please provide a maximum value",7E3,"rounded","dismissible"),this.maxValueInput.addClass("invalid"));d||Materialize.toast("Please make sure your range of values is valid",7E3,"rounded","dismissible")}}else $("#define-item-modal").closeModal(),this.nameInput.val(""),this.detailInput.val(""),this.initValueInput.val("0"),this.maxValueInput.val("0"),this.minValueInput.val("0")}}
