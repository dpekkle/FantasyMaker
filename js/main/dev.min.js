...
states.NEWJUMP:$(a).hasClass("prebuilt")&&current_state!=states.NEWFIGHT&&current_state!=states.NEWSTORE?exitStates():($(a).hasClass("deletebutton")&&removeElement(),current_state=states.DEFAULT,$(a).removeClass("activebutton"))}function choosePrebuilt(a){$(".prebuilt").addClass("activebutton");"Fight"==a?current_state=states.NEWFIGHT:"Store"==a&&(current_state=states.NEWSTORE)};var project={};console.log("Entering project.js");var project_project=initEmptyProject("none","none");defaultState();
function initEmptyProject(a,b){return{project_templates:{Default:{pagestyle:"width: 800px; height:600px; border: 3px solid black",outputcontainer:"",imgcontainers:[],vidcontainers:[],textcontainers:[],decisioncontainers:[]}},template_menus:new templateMenuObj,audio:new audioObj,projectOwner:a,projectName:b,dateCreated:"",lastModified:"",published:!0,title:b,author:a,description:"No description available.",imageLink:"",gameLink:"http://fmgamemaker.tk/play/"+a+"/"+b,graph:[],gameAttributes:{},attributesHTML:"",
resolution:{x:800,y:600}}}
function project_createNewProject(){myModal.prompt("Create New Project","You should manually save this project once you've created it to ensure that you can access it from any computer.",[{name:"Project Title","default":"",type:"text"}],function(a){project_project=initEmptyProject(users_getUsername(),a[0].trim());cy.elements().remove();$.when(http_save(project_project)).done($("#UI_projName").text("Project: "+project_project.projectName),showMainContent(),http_getUsersProjects(users_getUsername(),projectSettings_userProjectsNames))},
function(a){console.log("Verifying ",a[0]);if(""==a[0])return console.log("Project name empty"),!1;console.log("Project name succesfully verified");return!0})}
