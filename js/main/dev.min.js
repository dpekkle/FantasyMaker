...
a.gameLink),$("#currentProject_gameLink").text(a.gameLink),$("#currentProject_noGameLink").hide(),$("#currentProject_gameLink").show(),$("#pubSwitch").prop("checked",!0)):($("#currentProject_gameLink").hide(),$("#currentProject_noGameLink").show(),$("#pubSwitch").prop("checked",!1));$.when(projectSettings_prepareProjectsPage()).done(nav_toProjects())}
...
"play/"+a+"/"+b,graph:[],gameAttributes:{},attributesHTML:"",resolution:{x:1E3,y:800}}}
