...
for(b=0;b<a[0].graph.length;b++)"edges"!==a[0].graph[b].group&&cy.add(a[0].graph[b]);for(b=0;b<a[0].graph.length;b++)if("edges"===a[0].graph[b].group)cy.add(a[0].graph[b]).on("tap",function(a){this.select()});Materialize.toast("Project '"+project_project.projectName+"' Loaded",3E3,"rounded");resizeCanvas();defaultState()}},contenttype:"application/json"})}
...
function projectSettings_generateProjectCard(a){var b=a.projName.split("_").join(" ");return'<li><div class="col s1"><p></p></div><div class="card hoverable col s4" style="height: 200px;"><div class="card-content"><span class="card-title activator grey-text text-darken-4" style="position: relative;">'+b+'<i class="material-icons right">more_vert</i></span><div class="row"><p>Title: '+a.title+'</p></div><div class="row"><p>Author: '+a.author+'</p></div><div class="row" ><a href="#" class="btn col s8 offset-s2" onclick=projectSettings_prepThenNavToMain(\''+
a.projName+'\')>Load</a></div></div><div class="card-reveal" ><span class="card-title grey-text text-darken-4">'+b+'<i class="material-icons right">close</i></span><p>Date Created: '+a.dateCreated+"</p><p>Last Modified: "+a.lastModified+"</p>"+(!0===a.published?'<div id="'+a.projName+'_pub"><p style="color: green;">Published</p><p>Link to play game:<span><a href="'+a.gameLink+'" target="_blank">'+a.gameLink+"</a></span></p></div>":'<p id="'+a.projName+'_pub" class="pubTT tooltipped" data-position="bottom" data-delay="50" data-tooltip="Load your project and view the settings tab to publish your project for the world to see!" style="color: red;">Project is not published</p>')+
...
function project_login(){myModal.prompt("Log In","Log in and continue creating!",[{name:"Username","default":"",type:"text"},{name:"Password","default":"",type:"password"}],function(a){},function(a){a[0]=a[0].trim();if(0<=a[0].indexOf(" "))return myModal.warning("You cannot have spaces in your username"),!1;var b={data:{}};$.when(http_login(a[0],a[1],b)).done(function(){"INVALID_USERNAME"!==b.data&&"INVALID_PASSWORD"!==b.data&&"SERVER_ERR"!==b.data?project_successfulLogin(b):myModal.warning("Login details were invalid. Please try again.")})})}
...
function project_signUp(){myModal.prompt("Sign Up","Become a game creator with FantasyMaker!",[{name:"Username","default":"",type:"email"},{name:"Password","default":"",type:"password"},{name:"Confirm Password","default":"",type:"password"}],function(a){},function(a){a[0]=a[0].trim();if(""===a[0]||""===a[1]||""===a[2])return myModal.warning("All fields must be filed out."),!1;if(a[1]!==a[2])return myModal.warning("Your password and confirmation password do not match."),!1;if(0<=a[0].indexOf(" "))return myModal.warning("You cannot have spaces in your username"),
!1;var b=users_generateNewUser();b.username=a[0];b.password=a[1];$.when(http_signUp(b,"")).done(function(b){"VALID"===b?(Materialize.toast("Welcome to FantasyMaker "+a[0]+".",3E3,"rounded"),$("#prompt-modal").closeModal()):myModal.warning("That username has already been taken. Please try another username")})})}
...
d).length&&($("#newCondition_"+d).html(),e=conditions_createCondition(c,null),$("#newCondition_"+d+"_settings").attr("id","exCondition_"+e.edge+"_"+e.id+"_settings"),$("#newCondition_"+d).attr("id","exCondition_"+e.edge+"_"+e.id),$("#newCondition_"+d+"_attButton_s1_1").attr("id","exCondition_"+e.edge+"_"+e.id+"_attButton_s1_1"),$("#newCondition_"+d+"_compMenu_s1").attr("id","exCondition_"+e.edge+"_"+e.id+"_compMenu_s1"),0<$("#newCondition_"+d+"_attButton_s1_2").length?$("#newCondition_"+d+"_attButton_s1_2").attr("id",
"exCondition_"+e.edge+"_"+e.id+"_attButton_s1_2"):0<$("#newCondition_"+d+"_specValue_s1_2").length?($("#newCondition_"+d+"_specValue_s1_2").attr("id","exCondition_"+e.edge+"_"+e.id+"_specValue_s1_2"),$("#newCondition_"+d+"_specValue_s1_2_inputField").attr("id","exCondition_"+e.edge+"_"+e.id+"_specValue_s1_2_inputField"),$("#exCondition_"+e.edge+"_"+e.id+"_specValue_s1_2_inputField").attr("value",$("#exCondition_"+e.edge+"_"+e.id+"_specValue_s1_2_inputField").val())):0<$("#newCondition_"+d+"_randValue_s1_2").length&&
...
"_specValue_s2_1_inputField").attr("id","exCondition_"+e.edge+"_"+e.id+"_specValue_s2_1_inputField"),$("#exCondition_"+e.edge+"_"+e.id+"_specValue_s2_1_inputField").attr("value",$("#exCondition_"+e.edge+"_"+e.id+"_specValue_s2_1_inputField").val())):0<$("#newCondition_"+d+"_randValue_s2_1").length&&$("#newCondition_"+d+"_randValue_s2_1").attr("id","exCondition_"+e.edge+"_"+e.id+"_randValue_s2_1"),$("#newCondition_"+d+"_compMenu_s2").attr("id","exCondition_"+e.edge+"_"+e.id+"_compMenu_s2"),0<$("#newCondition_"+
d+"_attButton_s2_2").length?$("#newCondition_"+d+"_attButton_s2_2").attr("id","exCondition_"+e.edge+"_"+e.id+"_attButton_s2_2"):0<$("#newCondition_"+d+"_specValue_s2_2").length?($("#newCondition_"+d+"_specValue_s2_2").attr("id","exCondition_"+e.edge+"_"+e.id+"_specValue_s2_2"),$("#newCondition_"+d+"_specValue_s2_2_inputField").attr("id","exCondition_"+e.edge+"_"+e.id+"_specValue_s2_2_inputField"),$("#exCondition_"+e.edge+"_"+e.id+"_specValue_s2_2_inputField").attr("value",$("#exCondition_"+e.edge+
"_"+e.id+"_specValue_s2_2_inputField").val())):0<$("#newCondition_"+d+"_randValue_s2_2").length&&$("#newCondition_"+d+"_randValue_s2_2").attr("id","exCondition_"+e.edge+"_"+e.id+"_randValue_s2_2"),e.html=$("#exCondition_"+e.edge+"_"+e.id).html(),void 0!==e&&c.data.conditions.push(e));for(d=0;d<edgeOverlay_newOutcomeCount;d++)0<$("#newOutcome_"+d).length&&(e=conditions_createOutcome(c,null),$("#newOutcome_"+d+"_settings").attr("id","exOutcome_"+e.edge+"_"+e.id+"_settings"),$("#newOutcome_"+d).attr("id",
...
e.edge+"_"+e.id+"_specValue_2_inputField").attr("value",$("#exOutcome_"+e.edge+"_"+e.id+"_specValue_2_inputField").val()),$("#newOutcome_"+d+"_randValue_2").attr("id","exOutcome_"+e.edge+"_"+e.id+"_randValue_2"),$("#newOutcome_"+d+"_text_1").attr("id","exOutcome_"+e.edge+"_"+e.id+"_text_1"),$("#newOutcome_"+d+"_text_2").attr("id","exOutcome_"+e.edge+"_"+e.id+"_text_2"),e.html=$("#exOutcome_"+e.edge+"_"+e.id).html(),void 0!==e&&c.data.outcomes.push(e))}edgeOverlay_newOutcomeCount=edgeOverlay_newConditionCount=
0}function edgeOverlay_addNewCondition(a){var b="newCondition_"+edgeOverlay_newConditionCount,c=generateCondition_type1(b);$("#"+a).append(c);initAttributeButton(b+"_attButton_s1_1");initAttributeButton(b+"_attButton_s1_2");edgeOverlay_newConditionCount++}function edgeOverlay_addNewOutcome(a){var b="newOutcome_"+edgeOverlay_newOutcomeCount,c=generateOutcome(b);$("#"+a).append(c);initAttributeButton(b+"_attButton_1");initAttributeButton(b+"_attButton_2");edgeOverlay_newOutcomeCount++}
...
current_state=states.NEWFIGHT;cy.$("#fightparent"+cy.nodes(":parent").size()+1).select()};var conditionsContextMenu={};
$.contextMenu({selector:".condition-settings-context-menu",trigger:"left",build:function(a){var b={callback:function(a,b){var c="clicked: "+a;window.console&&console.log(c)||alert(c)},items:{}};a.hasClass("outcome")?(b.items.attMod={name:"Attribute Modification",callback:function(b,c){swapOutcome(b,a.attr("id"))}},b.items.playerOutputAttribute={name:"Player Output (Text : Attribute : Text)",callback:function(b,c){swapOutcome(b,a.attr("id"))}},b.items.playerOutputText={name:"Player Output (Text Only)",
callback:function(b,c){swapOutcome(b,a.attr("id"))}}):(b.items.type1={name:"Compare Two Attributes",callback:function(b,c){setComparisonType("type1",a.attr("id"))}},b.items.type2={name:"Compare Statement and Attribute",callback:function(b,c){setComparisonType("type2",a.attr("id"))}},b.items.type3={name:"Compare Two Statements",callback:function(b,c){setComparisonType("type3",a.attr("id"))}});b.items.sep={name:"----------------------------------------------",disabled:!0};var c=a.attr("id").split("_"),
...
callback:function(b,d){$("#"+a.attr("id")).text(b)}},">=":{name:">=",callback:function(b,d){$("#"+a.attr("id")).text(b)}}}}),a.hasClass("mods")&&(b.items.modifier={name:"Modifier",items:{"=":{name:"=",callback:function(b,d){$("#"+a.attr("id")).text(b)}},"+":{name:"+",callback:function(b,d){$("#"+a.attr("id")).text(b)}},"-":{name:"-",callback:function(b,d){$("#"+a.attr("id")).text(b)}},"*":{name:"*",callback:function(b,d){$("#"+a.attr("id")).text(b)}},"/":{name:"/",callback:function(b,d){$("#"+a.attr("id")).text(b)}}}}));
return b}});function handleSelection(a,b,c){console.log(a);"randValue"===a?randomSelected(b):"specValue"===a?numberSelected(b):"attButton"!==b.split("_")[2]?attributeSelected(a,b,c):($("#"+b).text(a),$("#"+b).attr("path",c.path),updateTooltip(b,c.path))}
...
"game-attributes numbers")+'</div><div class="divider"></div></li>'}function generateOutcome(a){return"<li id="+a+'><div class="row" type="Attribute Modification">'+generateSettingsButton(a)+generateAttributeButton(a+"_attButton_1","game-attributes")+generateComparisonButon(a+"_compMenu","mods","+")+generateAttributeButton(a+"_attButton_2","game-attributes numbers")+'</div><div class="divider"></div></li>'}
...
function generateBreakButton(a){return'<div class="col s1"><div id="'+a+'" class="attribute-button tooltipped" data-html="true" data-position="bottom" data-delay="50" data-tooltip="Defines a new line in the control output"> No Newline</div></div>'}
...
function gameInventory_definitionModal_delete(a){$("."+a+"-list-element").remove();gameInventory_deleteItem(a)};var genericComparisonRow={};function generic_example(){generic_addRow("row_1_","your-settings-menu","exampleList")}function generic_addRow(a,b,c){$("#"+c).append(generic_generateRow(a,b));initAttributeButton(a+"attButton1");initAttributeButton(a+"attbutton2")}$.contextMenu({selector:".your-settings-menu",trigger:"left",build:function(a){a={items:{}};a.items.dosomething={name:"do something",callback:function(a,c){alert("Done something")}};return a}});
function generic_generateRow(a,b){return"<li id="+a+'><div class="row" type="type1">'+generic_yourSettingsButton(a,b)+generic_generateAttributeButton(a+"attButton1","game-attributes")+generateComparisonButon(a+"_compMenu","comps","=")+generic_generateAttributeButton(a+"attbutton2","game-attributes numbers")+'</div><div class="divider"></div></li>'}
function generic_yourSettingsButton(a,b){return'<div class="col s1"><div id="'+a+'_settings" class="'+b+' condition-settings-button"><a class="btn-floating waves-effect waves-light gray"><i class="material-icons">settings</i></a></div></div>'}$.contextMenu({selector:".generic-attributes-menu",trigger:"left",build:function(a){return generic_generateContextMenu(a)}});$.contextMenu({selector:".generic-attributes-menu-right",trigger:"right",build:function(a){return generic_generateContextMenu(a)}});
...
function generic_attributeSelected(a,b){var c="",d="";d=$("#"+a).hasClass("input-field")?c=$("#"+a).closest("div").prop("id"):c=a;var e=generic_generateAttributeButton(d,"game-attributes numbers","NO_COL");$("#"+c).replaceWith(e);$("#"+d).children().text(b.name);$("#"+d).attr("path",b.path);updateTooltip(d,b.path)};var hotkeys={},nodes_to_clone;
...
function assessEdge(a){var b=cy.edges("[id='"+a+"']");logger.log("Assessing edge "+b.json().data.name+"<br>");if(void 0!==b){a=b.json().data.conditions;if(0<a.length){for(var b=!0,c=0;c<a.length;c++)!1===assessCondition(a[c])&&(b=!1);return b}logger.log("Edge "+b.json().data.name+" has no conditions.<br>");return!0}console.log("assessEdge(): invalid edge. unable to assess");return!1}function boolToString(a){return a?"true":"false"}
...
"("+b+") "+f+" "+getAttributeText(a[0].childNodes[3].childNodes[0])+"("+d+") "+c+" "+getAttributeText(a[0].childNodes[5].childNodes[0])+"("+h+")"+l+" "+getAttributeText(a[0].childNodes[7].childNodes[0])+"("+k+") is "+boolToString(e)+"<br>");return e}}
function getAttributeValue(a){if("specValue"===a.id.split("_")[3])return parseFloat(a.childNodes[0].value);if("randValue"===a.id.split("_")[3]){var b=parseFloat(a.attributes.min.value);a=parseFloat(a.attributes.max.value);return Math.floor(Math.random()*(a-b+1))+b}return gameAttributes_find(a.attributes.path.nodeValue).value}
function getAttributeText(a){if("specValue"===a.id.split("_")[3])return a.childNodes[0].value;if("randValue"===a.id.split("_")[3])return"a random number";a=a.attributes.path.value.split("_");for(var b,c,d=0;d<a.length;d++)0===d?(c=a[d],b=gameAttributes_find(c).name):(c+="_"+a[d],b+=" : "+gameAttributes_find(c).name);return b}
function assessComparison(a,b,c){a=parseFloat(a);c=parseFloat(c);switch(b){case "=":return a===c?!0:!1;case "!=":return a!==c?!0:!1;case ">":return a>c?!0:!1;case "<":return a<c?!0:!1;case ">=":return a>=c?!0:!1;case "<=":return a<=c?!0:!1}}function assessModification(a,b,c){a=parseInt(a);c=parseInt(c);switch(b){case "=":return c;case "+":return a+c;case "-":return a-c;case "*":return a*c;case "/":return a/c}};var playGame={};function loadingScreen(a){a?($("#loader").show(),$(".progressbutton").hide()):($("#loader").hide(),$(".progressbutton").show())}
...
for(f=0;f<b.length;f++)assessEdge(currentNode.outgoers("[name='"+b[f].name+"']").id())&&$(".playpage").append(b[f].html);$(".playpage").append(e);$(".output-container").hasClass("player")?$(".output-container").children().append(logger.playerOutput()):$(".output-container").hasClass("maker")&&$(".output-container").children().append(logger.makerOutput());logger.flush();$(".playpage").children("div[class^='decision-container']").each(function(a){$(this).click(function(){progressStory(a)})});$(".playpage .handlecontainer").hide();
