...
function project_createNewProject(){myModal.prompt("Create New Project","Enter a title for your project.",[{name:"Project Title","default":"",type:"text"}],function(a){},function(a){var b=project_generateID();project_project=initEmptyProject(users_getUsername(),b);project_project.title=a[0];cy.elements().remove();var c={data:[]};$.when(http_save(project_project,c)).done(function(){!0===c.data?(Materialize.toast("Project '"+project_project.title+"' created!",3E3,"rounded"),$("#prompt-modal").closeModal(),
$("#UI_projName").text("Project: "+project_project.title),nav_toMain(),http_getUsersProjects(users_getUsername(),projectSettings_userProjects)):Materialize.toast("Failed to create project. Please log in again.",3E3,"rounded")})})}
...
$.contextMenu({selector:".swap-controlmenu",trigger:"left",build:function(a){a={items:{}};a.items.maker={name:"Game Maker Output",callback:function(a,c){$(".output-container").hasClass("maker")||($(".output-container").removeClass("player"),$(".output-container").addClass("maker"))}};a.items.player={name:"Game Player Output",callback:function(a,c){$(".output-container").hasClass("player")||($(".output-container").removeClass("maker"),$(".output-container").addClass("player"))}};return a}});var gameAttributes={};function GameAttribute(a,b,c,d,e,f,g,h,k){this.name=a.name;this.is_leaf=a.is_leaf;this.initValue=this.value=a.value;this.maxValue=a.maxValue;this.minValue=a.minValue;this.parentPath=a.parentPath;this.id=a.id;this.description=a.description;null!=a.parentPath?(this.level=a.level+1,this.path=a.parentPath+"_"+a.id):(this.path=a.id,this.level=0);this.childrenArray=[]}var currentAttributeObj=null;
...
$("#player-items-list").collapsible({accordion:!1})};this.openInventory=function(){$("#player-inventory-modal").openModal({dismissible:!0,ready:function(){},complete:function(){$("#player-items-list").empty()}})}};k.init();$(".playpage").find("div[class^='inventory']").each(function(a){$(this).click(function(){console.log("Open inventory");k.appendItems();k.openInventory()})});$(".playpage").find("div[class^='character']").each(function(a){$(this).click(function(){console.log("Open Character Sheet")})});
$(".playpage").find("div[class^='jump']").each(function(a){$(this).click(function(){button_name=$(this).attr("jumpnode");console.log("Button name is: ",button_name);jump_node=cy.$('.jump[button ="'+button_name+'"]')[0];console.log("Jump node is: ",jump_node);void 0===jump_node?console.log("Jump_node is undefined?"):(jump_node.data("origin",currentNode),currentNode=runJumpNode(jump_node),console.log("We jumped!"),parseNode())})});$(".playpage").find("div[class^='jumpback']").each(function(a){$(this).click(function(){console.log("Go back from jump node");
currentNode=runJumpEnd(currentNode);parseNode()})});$(".playpage .handlecontainer").hide();$(".playpage").children().removeClass("resize-element");$(".playpage").children().removeClass("resize-child");$(".playpage").children().children().removeClass("resize-element");$(".playpage").children().attr("contenteditable","false");$(".playpage").children().children().attr("contenteditable","false")}function progressStoryViaButton(a){}
