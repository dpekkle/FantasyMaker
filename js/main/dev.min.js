...
function openAttributesOverlay(){$("#attributes-modal").openModal({dismissible:!0,ready:function(){gameAttributes_createModule_recursiveListDisplayAll();$(".attributesButton").hide();gameAttributes_createModule_displayFolder(!1)},complete:function(){}})}function openInventoryDefinitionOverlay(){$("#inventory-definition-modal").openModal({dismissible:!0,ready:function(){gameInventory_createModule_populateItemsList()},complete:function(){$(".inventory-item-list").empty()}})}
...
a.id+'\')"><i class="material-icons small">mode_edit</i></a></div>',d.append(b),void 0==a.minValue&&$("#"+a.id+"-min-value").text("\u221e"),void 0==a.maxValue&&$("#"+a.id+"-max-value").text("\u221e")):(a='<div class="folder card-panel hoverable" onclick="gameAttributes_createModule_displayFolder(\''+a.path+'\')"><h6 class="folder-title ">'+a.name+"</h6></div>",c.append(a))}
