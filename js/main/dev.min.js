...
"text-border-width":"2px","transition-property":"text-valign","transition-duration":"0.8s"}},{selector:".named",style:{label:"data(name)","text-background-color":"white","text-background-opacity":1,"text-border-opacity":1,"text-border-color":"black","text-border-width":"2px"}},{selector:".expanded",style:{}},{selector:".collapsed",style:{}},{selector:".hidden",style:{opacity:"0"}},{selector:".page",style:{shape:"roundrectangle","background-color":"#aaaaaa"}},{selector:".jump",style:{width:35,height:35,
shape:"polygon","shape-polygon-points":[0,-1,-1,.5,1,.5],"background-color":"#FFBB89","text-background-color":"white","text-background-opacity":1,"text-background-shape":"roundrectangle","text-halign":"center","text-valign":"top","text-border-opacity":1,"text-border-color":"black","text-border-width":"2px"}},{selector:".jumpend",style:{width:35,height:35,shape:"polygon","shape-polygon-points":[0,1,-1,-.5,1,-.5],"background-color":"#FFBB89"}},{selector:".control",style:{shape:"ellipse","background-color":"#7E9ED8"}},
{selector:".source_node",style:{"border-width":7,"border-color":"#90caf9","transition-duration":"0.1s"}},{selector:".disconnected",style:{"border-width":7,"border-color":"red","transition-property":"border-width, border-color","transition-duration":"0.1s"}},{selector:".jumpenderror",style:{"border-width":7,"border-color":"orange","transition-property":"border-width, border-color","transition-duration":"0.1s"}},{selector:".start",style:{width:40,height:40,"background-color":"#9deaa6","padding-left":"2px",
"padding-right":"2px"}},{selector:".leaf",style:{width:35,height:35,shape:"octagon","background-color":"#eacd9d"}},{selector:".jumpedge",style:{label:"","text-background-opacity":0,"text-border-opacity":0,"text-border-width":0,"line-color":"#FFBB89","target-arrow-color":"#FFBB89","text-border-color":"#FFBB89"}},{selector:".pageedge",style:{}},{selector:".success-edge",style:{"line-color":"#a1d490","target-arrow-color":"#a1d490","text-border-color":"#a1d490"}},{selector:".fail-edge",style:{"line-color":"#c390d4",
"target-arrow-color":"#c390d4","text-border-color":"#c390d4"}},{selector:".parent-selected",style:{"line-style":"dashed"}},{selector:":selected",style:{"text-border-color":"black","border-width":5,"line-color":"black","target-arrow-color":"black","transition-duration":"0.1s"}}],headless:cytoscape_headless,boxSelectionEnabled:!0,selectionType:"single",minZoom:.2,maxZoom:5});cy.panzoom();resizeCanvas();console.log("Canvas done");var httpRequests={};console.log("Enter httpRequests.js");function http_redirectHome(){window.location=host_create()}function http_save(a,b){http_addTokenToHeader();return $.ajax({type:"POST",url:"/saveProject",data:{save:JSON.stringify(a)},success:function(a){http_handleAuth(a)?b.data=!0:(b.data=!1,console.log(a))},contenttype:"application/json"})}
...
function createFight(a){console.log(a.cyRenderedPosition);var b=!1;0===cy.elements(".page").size()&&(b=!0);var c=cy.add([{data:{id:"fightparent"+cy.nodes(":parent").size()+1,name:"Fight"},classes:"expanded",group:"nodes",style:{"z-index":cy.nodes(":parent").size()+1}},{data:{displacement:{x:0,y:0},parent:"fightparent"+cy.nodes(":parent").size()+1,name:cy.nodes(".page, .control").size()+1,pagestyle:[],outputcontainer:[],debugcontainer:[],imgcontainers:[],vidcontainers:[],textcontainers:[],decisioncontainers:[],
specialbuttons:[],events:[],eventspane:'<div class= "eventscontainer"><span class="eventspanetitle eventname" style="text-align:center; font-size: 16px;">Asset</span><span class="eventspanetitle eventtype" style="text-align:center; font-size: 16px;">Event</span><span class="eventspanetitle eventtrigger" style="text-align:center; font-size: 16px;">Trigger</span></div>'},classes:"page",group:"nodes",renderedPosition:a.cyRenderedPosition},{data:{displacement:{x:-40,y:100},parent:"fightparent"+cy.nodes(":parent").size()+
1,name:cy.nodes(".page, .control").size()+2,pagestyle:[],outputcontainer:[],debugcontainer:[],imgcontainers:[],vidcontainers:[],textcontainers:[],decisioncontainers:[],specialbuttons:[],events:[],eventspane:'<div class= "eventscontainer"><span class="eventspanetitle eventname" style="text-align:center; font-size: 16px;">Asset</span><span class="eventspanetitle eventtype" style="text-align:center; font-size: 16px;">Event</span><span class="eventspanetitle eventtrigger" style="text-align:center; font-size: 16px;">Trigger</span></div>'},
classes:"page",group:"nodes",renderedPosition:a.cyRenderedPosition},{data:{displacement:{x:40,y:100},parent:"fightparent"+cy.nodes(":parent").size()+1,name:cy.nodes(".page, .control").size()+3,pagestyle:[],outputcontainer:[],debugcontainer:[],imgcontainers:[],vidcontainers:[],textcontainers:[],decisioncontainers:[],specialbuttons:[],events:[],eventspane:'<div class= "eventscontainer"><span class="eventspanetitle eventname" style="text-align:center; font-size: 16px;">Asset</span><span class="eventspanetitle eventtype" style="text-align:center; font-size: 16px;">Event</span><span class="eventspanetitle eventtrigger" style="text-align:center; font-size: 16px;">Trigger</span></div>'},
...
current_state=states.NEWFIGHT;cy.$("#fightparent"+cy.nodes(":parent").size()+1).select()}function fixDisappearingBug(){0!==cy.$(".start").size()&&cy.$(".start").data("fakeattribute",1)}var fixbug=setInterval(function(){fixDisappearingBug()},200);var conditionsContextMenu={};
...
function stylePage(){$(".playpage").html("");$(".playpage").attr("style",currentNode.data("pagestyle"));resizePlayPage();var a=currentNode.data("textcontainers"),b=currentNode.data("decisioncontainers"),c=currentNode.data("imgcontainers"),d=currentNode.data("vidcontainers"),e=currentNode.data("specialbuttons"),f=currentNode.data("outputcontainer");currentNode.data("events");for(var g=0;g<a.length;g++)$(".playpage").append(a[g].html);for(g=0;g<c.length;g++)$(".playpage").append(c[g].html);for(g=0;g<
d.length;g++)$(".playpage").append(d[g].html);for(g=0;g<e.length;g++)$(".playpage").append(e[g].html);for(g=0;g<b.length;g++)assessEdge(currentNode.outgoers("[name='"+b[g].name+"']").id())&&$(".playpage").append(b[g].html);$(".playpage").append(f);$(".output-container").hasClass("player")?$(".output-container").children().append(logger.playerOutput()):$(".output-container").hasClass("maker")&&$(".output-container").children().append(logger.makerOutput());$(".playpage").children("div[class^='decision-container']").each(function(a){$(this).click(function(){progressStory(a)})});
$(".playpage").find("div[class^='inventory']").each(function(a){$(this).click(function(){console.log("Open inventory");openInventorySheet()})});$(".playpage").find("div[class^='character']").each(function(a){$(this).click(function(){console.log("Open Character Sheet");openCharacterSheet()})});$(".playpage").find("div[class^='jump']").each(function(a){$(this).click(function(){button_name=$(this).attr("jumpnode");console.log("Button name is: ",button_name);jump_node=cy.$('.jump[button ="'+button_name+
'"]')[0];console.log("Jump node is: ",jump_node);void 0===jump_node?console.log("Jump_node is undefined?"):(jump_node.data("origin",currentNode),currentNode=runJumpNode(jump_node),console.log("We jumped!"),parseNode())})});$(".playpage").find("div[class^='jumpback']").each(function(a){$(this).click(function(){console.log("Go back from jump node");currentNode=runJumpEnd(currentNode);parseNode()})});$(".playpage .handlecontainer").hide();$(".playpage").children().removeClass("resize-element");$(".playpage").children().removeClass("resize-child");
