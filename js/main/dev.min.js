...
function assessCondition(a){a=$.parseHTML(a);var b=a[0].attributes[1].value;if("1"===b){var b=getAttributeValue(a[0].childNodes[1].childNodes[0]),c=a[0].childNodes[2].childNodes[0].data,d=getAttributeValue(a[0].childNodes[3].childNodes[0]),e=assessComparison(b,c,d);logger.log("Condition: "+getAttributeText(a[0].childNodes[1].childNodes[0])+"("+b+") "+c+" "+getAttributeText(a[0].childNodes[3].childNodes[0])+"("+d+") is "+boolToString(e)+"<br>");return e}if("2"===b){var b=getAttributeValue(a[0].childNodes[1].childNodes[0]),
