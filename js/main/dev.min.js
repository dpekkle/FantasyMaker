...
for(h=0;h<d.length;h++)$(".playpage").append(d[h].html);for(h=0;h<e.length;h++)$(".playpage").append(e[h].html);for(h=0;h<b.length;h++)assessEdge(currentNode.outgoers("[name='"+b[h].name+"']").id())&&$(".playpage").append(b[h].html);$(".playpage").append(f);window.location.href!==host_play()&&$(".playpage").append(g);$(".player").children().append(logger.playerOutput());$(".maker").children().append(logger.makerOutput());$(".playpage").find("div[class^='decision-container']").each(function(a){$(this).click(function(){name=
