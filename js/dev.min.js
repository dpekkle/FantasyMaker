...
function createConnection(a){current_state==states.CONNECTING&&a.isNode()&&(null==source_node?(source_node=a,console.log("Source node assigned as node",a.data("id"))):(console.log("Creating link from ",source_node.data("id")," to ",a.data("id")),source_node.data("id")!=a.data("id")&&(cy.add({data:{source:source_node.data("id"),target:a.data("id"),text:"<Decision text to display)>"},classes:"connection",group:"edges"}),source_node=null)))};var interactCanvas={};console.log("Enter interactCanvas.js");total_pages=0;
