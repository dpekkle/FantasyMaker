...
function showPageOverlay(a){var b=a;null===a&&(b=cy.$(":selected")[0]);$(".toolbar").hide();$("#modalcontainers").children().hide();overlayToolbar(b);if(b.hasClass("page"))for($("#pagecontainers").show(),$("#pagecontainers #pagetext").html(escapeHtml(b.data("text"))),outgoingEdges=b.outgoers().edges(),b=0;b<outgoingEdges.size();b++)$("#pagecontainers").append("<button class = 'decisionbutton' id='decision"+b+"'>"+escapeHtml(outgoingEdges.eq(b).data("text"))+"</button>");null===a&&document.getElementById("Modal").showModal()}
