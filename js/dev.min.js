...
function dragMoveListener(a){var b=a.target,c=(parseFloat(b.getAttribute("data-x"))||0)+a.dx;a=(parseFloat(b.getAttribute("data-y"))||0)+a.dy;b.style.webkitTransform=b.style.transform="translate("+c+"px, "+a+"px)";b.setAttribute("data-x",c);b.setAttribute("data-y",a)}window.dragMoveListener=dragMoveListener;function modalBounds(){}var doit;window.onresize=function(){clearTimeout(doit);doit=setTimeout(modalBounds,300)};var prompts={};
...
a};this.prompt=function(a,b,c,d){var e=$("#prompt-modal .modal-content"),f=[];$("#prompt-modal").openModal({dismissible:!1,ready:function(){e.html("");e.append('<h3 style="text-align:center;">'+a+"</h3>");e.append("<p>"+b+"<p>");for(var d=0;d<c.length;d++)e.append('<label for="'+d+'"> '+c[d].name+"</label>"),e.append('<input id= "'+d+'"type="'+c[d].type+'" value = "'+c[d]["default"]+'">')},complete:function(){e.children("input").each(function(a){f.push($(this).val())});d(f)}})}}myModal=new myModal;
myModal.init();var pageOverlay={},show_handles=!0;function updatePageStyle(a){openEditPageOverlay(a);closeOverlay(a)}function toggleHandles(){show_handles=!show_handles;$(".handlemode").toggleClass("activebutton");show_handles?($(".handlecontainer").show(),$(".handlemode").html("Handles: Shown")):($(".handlecontainer").hide(),$(".handlemode").html("Handles: Hidden"))}
...
show_handles||$(".handlecontainer").hide();bindHandleSelection()}
function addImageContainer(){var a;myModal.prompt("Add image","Directly link a jpeg|jpg|gif|png",[{name:"Image URL","default":"http://",type:"text"},{name:"Test","default":"wew",type:"number"}],function(b){if(myModal.confirm){var c=b[0];b=genPageCenterHTML(300,220);null!=c&&(a="<div class='img-container drag-element' style='position:absolute; "+b+"'>",b=checkImageURL(c,"img"))&&(a+=b,a+="</div>",$.ajax({url:c,success:function(b){b=$(".img-container").length;var c=htmlToElements(a);$("#pagecontainers").append(c);
$("#pagecontainers div.img-container:last").prepend(genHandleHTML("img",b+1));bringContainerToFront($("pagecontainers div.img-container:last"));show_handles||$(".handlecontainer").hide();bindHandleSelection()},error:function(a){alert("URL: "+c+" does not exist")}}))}})}
...
function stylePage(){$(".playpage").html("");$(".playpage").attr("style",currentNode.data("pagestyle"));var a=currentNode.data("textcontainers"),b=currentNode.data("decisioncontainers"),c=currentNode.data("imgcontainers"),d=currentNode.data("outputcontainer");currentNode.data("events");for(var e=0;e<a.length;e++)$(".playpage").append(a[e].html);for(e=0;e<c.length;e++)$(".playpage").append(c[e].html);for(e=0;e<b.length;e++)$(".playpage").append(b[e].html);$(".playpage").append(d);$(".playpage").children("div[class^='decision-container']").each(function(a){$(this).click(function(){progressStory(a)})});
$(".playpage .handlecontainer").hide();$(".playpage").children().removeClass("resize-element");$(".playpage").children().children().removeClass("resize-element");$(".playpage").children().attr("contenteditable","false");$(".playpage").children().children().attr("contenteditable","false")}
