...
function dragMoveListener(a){var b=a.target,c=(parseFloat(b.getAttribute("data-x"))||0)+a.dx;a=(parseFloat(b.getAttribute("data-y"))||0)+a.dy;b.style.webkitTransform=b.style.transform="translate("+c+"px, "+a+"px)";b.setAttribute("data-x",c);b.setAttribute("data-y",a)}window.dragMoveListener=dragMoveListener;var edgeOverlay={},edgeOverlay_constraintCount=0;function populateStatsDropDownMenu(a){a="#statTypeList"+a;$(a).children().remove();for(var b=0;b<project_project.statTypes.length;b++)$(a).append('<option value="'+project_project.statTypes[b].type+'">'+project_project.statTypes[b].type+"</option>")}
function edgeOverlay_addConstraint(){var a='<li><ul class="nav nav-pills" id="constraintsList"><li><select class="form-control" id="statTypeList'+edgeOverlay_constraintCount+'"><select></li><li><select class="form-control"><option value="=">=</option><option value=">">></option><option value="<"><</option><option value=">=">>=</option><option value="<="><=</option></select></li><li><input type="text" class="form-control" id="statsValInput" placeholder="Enter value"></li></ul><li>';$("#constraintList").append(a);
populateStatsDropDownMenu(edgeOverlay_constraintCount);edgeOverlay_constraintCount++}
function edgeOverlay_addOutcome(){var a='<li><ul class="nav nav-pills"><li><select class="form-control" id="statTypeList'+edgeOverlay_constraintCount+'"><select></li><li><select class="form-control"><option value="+">+</option><option value="-">-</option><option value="/">/</option><option value="*">*</option><option value="=">=</option></select></li><li><input type="text" class="form-control" id="statsValInput" placeholder="Enter value"></li></ul></li>';$("#constraintList").append(a);populateStatsDropDownMenu(edgeOverlay_constraintCount);
edgeOverlay_constraintCount++};var playGame={};outgoingEdges=currentNode=null;function prepareForGame(){outgoingEdges=currentNode=null;$(".playpage").html("")}function parseNode(){console.log("Parse node ",currentNode.data("id"));outgoingEdges=currentNode.outgoers().edges();currentNode.hasClass("page")?parsePage(outgoingEdges):currentNode.hasClass("control")&&parseControl(outgoingEdges)}function parsePage(a){stylePage()}
