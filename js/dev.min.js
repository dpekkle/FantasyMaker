...
"fail-edge":"success-edge":c=!1}c&&cy.add({data:{source:source_node.data("id"),target:a.data("id"),text:"<Decision text to display)>"},classes:b,group:"edges"});source_node.removeClass("source_node");source_node=null;a.unselect()}}function resizeCanvas(){var a=$(window).width(),b=$(window).height(),c=$("#tabheadings").height();$("#cy").css("width",9*a/12-30);$("#cy").css("height",b-c);$("#sidebar").css("height",b-c);console.log("We resized, width: "+a+" height: "+b);cy.resize()}$(window).resize(resizeCanvas);
var observer=new MutationObserver(function(a){a.forEach(function(a){"tab-pane fade"==a.oldValue&&"tab-pane fade active in"==a.target.className&&cy.resize()})}),cytabNode=$("#cyTab")[0],observerConfig={attributes:!0,childList:!1,characterData:!1,attributeOldValue:!0,attributeFilter:["class"]};observer.observe(cytabNode,observerConfig);var canvasEvents={};console.log("Enter canvasEvents.js");total_pages=0;source_node=null;cy.$("edge").on("tap",function(a){this.select()});
