...
function testConnectivity(){var a=!1,b=cy.$("node").first(),e=cy.$("node");console.log("Root node: "+b.data("id"));var c=cy.collection(),c=c.add(b);cy.elements().dfs({roots:b,visit:function(a,b,d){c=c.add(d);console.log("visit "+this.id()+" total "+a)},directed:!0});console.log("Total nodes:"+e.size()+" Connected_nodes: "+c.size());if(e.size()==c.size())a=!0;else{alert("Graph is not connected");var d=e.diff(c).left;console.log("Disconnected:",d.size());console.log("left: "+d.map(function(a){return a.id()}).join(", "));d.addClass("disconnected");
