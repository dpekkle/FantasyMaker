...
$(".playpage .handle").hide();$(".playpage").children().removeClass("resize-element");$(".playpage").children().children().removeClass("resize-element");$(".playpage").children().attr("contenteditable","false");$(".playpage").children().children().attr("contenteditable","false")}function parseControl(a,b){progressStory(0)}function getIndexFromOutgoingEdges(a,b){for(var c=b.jsons(),d=0;d<c.length;d++)if(c[d].data.id===a)return d;return-1}
