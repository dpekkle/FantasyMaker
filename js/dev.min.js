...
var cy=cytoscape({container:document.getElementById("cy"),layout:{name:"grid",rows:1},style:[{selector:"node",style:{content:"data(id)","text-opacity":1,"text-valign":"center","text-halign":"center","border-width":5,"border-opacity":0,"border-color":"black","transition-property":"border-width, border-opacity, border-color","transition-duration":"0.5s"}},{selector:"edge",style:{width:4,"target-arrow-shape":"triangle","line-color":"#9dbaea","target-arrow-color":"#9dbaea","curve-style":"bezier"}},{selector:":selected",
style:{"border-opacity":1,"line-color":"black","target-arrow-color":"black"}},{selector:".page",style:{shape:"roundrectangle","background-color":"light-gray"}},{selector:".control",style:{shape:"ellipse","background-color":"yellow"}},{selector:".source_node",style:{"border-width":7,"border-opacity":1,"border-color":"#9dbaea"}},{selector:".disconnected",style:{"border-width":7,"border-opacity":1,"border-color":"red"}}],elements:{nodes:[],edges:[]},selectionType:"single",minZoom:1E-10,maxZoom:1E10});
console.log("Canvas done");var states={DEFAULT:0,CONNECTING:1,NEWPAGE:2,NEWCONTROL:3};current_state=states.DEFAULT;
function changeState(a){$("#sidebar .button").removeClass("activebutton");$(a).addClass("activebutton");$(a).hasClass("connectionmode")&&current_state!=states.CONNECTING?(current_state=states.CONNECTING,source_node=null):$(a).hasClass("pagemode")&&current_state!=states.NEWPAGE?current_state=states.NEWPAGE:$(a).hasClass("controlmode")&&current_state!=states.NEWCONTROL?current_state=states.NEWCONTROL:($(a).hasClass("deletebutton")&&removeNode(),setDefaultState(a))}
