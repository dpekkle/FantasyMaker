...
cy.on("tapend",function(a){var b=a.cyTarget;b===cy&&cy.$(":selected").unselect();current_state!==states.CONNECTING||b!==source_node&&b!==cy||null===source_node||(source_node.removeClass("source_node"),source_node=null);current_state===states.NEWPAGE?b===cy&&cy.add({data:{id:++total_pages,text:"page text",img:"none",audio:"none"},classes:"page",group:"nodes",renderedPosition:a.cyRenderedPosition}):current_state===states.NEWCONTROL&&b===cy&&cy.add({data:{id:++total_pages,text:"control node text"},classes:"control",
