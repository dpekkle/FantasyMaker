...
b){}},Colour:{name:"Colour",callback:function(a,b){}},Corners:{name:"Corners",callback:function(a,b){}},Thickness:{name:"Thickness",callback:function(a,b){}},Style:{name:"Style",callback:function(a,b){}}}},"delete":{name:"Delete",icon:"delete",callback:function(a,b){alert("Are you sure you want to delete this container?");b.$trigger.parent().parent().remove()}}}})});var edgeOverlay={},edgeOverlay_newConditionCount=0,edgeOverlay_newOutcomeCount=0,edgeOverlay_selectedEdge;function populateEdgeOverlay(a){edgeOverlay_newOutcomeCount=edgeOverlay_newConditionCount=0;edgeOverlay_selectedEdge=a;for(var b=0;b<a.data.conditions.length;b++){var c=a.data.conditions[b];console.log(c);edgeOverlay_addExistingCondition("conditionsList",c)}for(b=0;b<a.data.outcomes.length;b++)c=a.data.outcomes[b],edgeOverlay_addExistingOutcome("outcomesList",c)}
...
function setDefaultFailEdge(a){if(null!==currentSelectedNode&&void 0!==currentSelectedNode){var b="#defaultIcon_"+currentSelectedNode.json().data.defaultFailEdge;$(b).html("");$("#defaultIcon_"+a).html("stars");currentSelectedNode.json({data:{defaultFailEdge:a}});console.log("new default is "+a)}}
...
$("#"+b).css("transition",""))})};var dragDrop={};grid_snapping_mode=!1;var grid_targets=interact.createSnapGrid({x:10,y:10,range:10,offset:{x:-2,y:2}});function initSnapOptions(){return grid_snapping_mode?{targets:[grid_targets],relativePoints:[{x:1,y:1}],endOnly:!1}:{targets:[],relativePoints:[{x:1,y:1}],endOnly:!1}}var snap_options=initSnapOptions();
