...
function showPageOverlay(a){var b=a;null===a&&(b=cy.$(":selected")[0]);$(".toolbar").hide();$("#modalcontainers").children().hide();overlayToolbar(b);if(b.hasClass("page")){$("#pagecontainers").show();$("#pagecontainers #pagetext").html(escapeHtml(b.data("text")));outgoingEdges=b.outgoers().edges();for(var c=0;c<outgoingEdges.size();c++)$("#pagecontainers").append("<button class = 'decisionbutton' id='decision"+c+"'>"+escapeHtml(outgoingEdges.eq(c).data("text"))+"</button>")}b.isEdge()&&($("#connectioncontainers").show(),
$("#connectioncontainers #decisiontext").html(escapeHtml(b.data("text"))));null===a&&document.getElementById("Modal").showModal()}
function overlayToolbar(a){a.hasClass("control")?($("#controltoolbar").show(),$("#controlname").text("control "+a.data("id")),document.getElementById("controltext").value=a.data("text")):a.hasClass("page")?($("#pagetoolbar").show(),$("#pagename").text("Page "+a.data("id")),changeImage(a),changeAudio(a)):a.isEdge()&&($("#connectiontoolbar").show(),$("#connectionname").text("Connection"),document.getElementById("connectiontext").value=a.data("text"))}
...
function stylePage(){var a=currentNode.data("styleHTML");$(".playpage").html(a);a.includes("pagetext")&&($(".playpage #pagetext").html(escapeHtml(currentNode.data("text"))),console.log(currentNode.data("text")));if(a.includes("decisionbutton")){console.log("Let's bind buttons");var b=0;$(".playpage").children("button").each(function(a){console.log("Bound button, i = ",a);$(this).click(function(){progressStory(a)});b++});console.log("Decisions total: ",b)}}function parseControl(a){}
