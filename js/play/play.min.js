...
function saveProject(){for(var a=cy.elements(".page"),b=0;b<a.length;b++)updatePageStyle(a[b]);project_saveProject()}function setStart(a){cy.$(".start").removeClass("start");void 0!==a?(a.addClass("start"),a.removeClass("leaf")):(cy.$(":selected")[0].addClass("start"),cy.$(":selected")[0].removeClass("leaf"))}function removeParent(){cy.$(":selected")[0].move({parent:null})}
...
$(document).ready();$("select").material_select();$(".button-collapse").sideNav();var ret={};http_validateToken(ret);var testgraph={};function runPlayGameTests(){var a=checkValidGraph();""==a?createModule_playGame():(a.push("Continue Anyway?"),myModal.prompt("Graph Tests Failed",a,[],function(a){createModule_playGame()}))}
