...
var states={DEFAULT:0,CONNECTING:1,NEWPAGE:2,NEWCONTROL:3},cytoscape_headless,cytoscape_container;window.location.href===host_play()?(cytoscape_headless=!0,cytoscape_container=null):(cytoscape_headless=!1,cytoscape_container=document.getElementById("cy"));
...
states={DEFAULT:0,CONNECTING:1,NEWPAGE:2,NEWCONTROL:3,NEWJUMP:4,NEWJUMPEND:5,NEWEMPTY:6,NEWFIGHT:7};current_state=states.DEFAULT;function defaultState(){exitStates();current_state=states.DEFAULT}function exitStates(){current_state==states.CONNECTING&&(cy.boxSelectionEnabled(!0),null!==source_node&&(source_node.removeClass("source_node"),source_node=null));$("#sidebar .btn").removeClass("activebutton");$(".pagemode").html("Page Node");cy.$(":parent").selectify()}
