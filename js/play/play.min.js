...
function chooseJump(a){console.log("Choose jump mode:",a);$(".jumpmode").addClass("activebutton");"Start"==a&&(current_state=states.NEWJUMP,console.log("Set state to:",current_state))}
