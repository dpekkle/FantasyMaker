...
function populateJumpOverlay(a){a=a.data("triggerType");loadJumpConditions();loadJumpButton();setJumpNodeType(a);$('#choosejumprepeat input[value="'+cy.$(":selected")[0].data("repeat")+'"]').prop("checked",!0);$("#choosejumptrigger :checked").prop("checked","")}
