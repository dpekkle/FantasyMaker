...
function project_createNewProject(){myModal.prompt("Create New Project","Enter a title for your project.",[{name:"Project Title","default":"",type:"text"}],function(a){},function(a){var b=project_generateID();project_project=initEmptyProject(users_getUsername(),b);project_project.title=a[0];gameAttributes_addAttributeFolder(!1,"Player","PLAYER");project_project.gameAttributes.PLAYER.NO_DELETE=!0;gameAttributes_addAttributeFolder(!1,"Enemies","ENEMIES");project_project.gameAttributes.ENEMIES.NO_DELETE=
!0;cy.elements().remove();var c={data:[]};$.when(http_save(project_project,c)).done(function(){!0===c.data?(Materialize.toast("Project '"+project_project.title+"' created!",3E3,"rounded"),$("#prompt-modal").closeModal(),$("#UI_projName").text("Project: "+project_project.title),nav_toMain(),http_getUsersProjects(users_getUsername(),projectSettings_userProjects)):Materialize.toast("Failed to create project. Please log in again.",3E3,"rounded")})})}
