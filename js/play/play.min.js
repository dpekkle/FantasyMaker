...
function choosePrebuilt(a){$(".prebuilt").addClass("activebutton");"Empty"==a?current_state=states.NEWEMPTY:"Fight"==a&&(current_state=states.NEWFIGHT)}function chooseJump(a){$(".jumpmode").addClass("activebutton");"Start"==a?current_state=states.NEWJUMP:"End"==a&&(current_state=states.NEWJUMPEND)}
...
var states={DEFAULT:0,CONNECTING:1,NEWPAGE:2,NEWCONTROL:3},cytoscape_headless,cytoscape_container;window.location.href!==host_play()?(cytoscape_headless=!1,cytoscape_container=document.getElementById("cy")):(cytoscape_headless=!0,cytoscape_container=null);
...
function updatePageStyle(a){openEditPageOverlay(a);closeOverlay(a)}function toggleHandles(){show_handles=!show_handles;$(".handlemode").toggleClass("activebutton");show_handles?($(".handlecontainer").show(),$(".handlemode").html("Handles: Shown"),$(".pagemenu").show()):($(".handlecontainer").hide(),$(".handlemode").html("Handles: Hidden"),$(".pagemenu").hide())}
