...
a+")"});$(".playpage").css({"-webkit-transform":"scale("+a+")"})}$(window).resize(resizePlayPage);console.log("Enter main.js version 0.5.0");$(document).ready();$("select").material_select();$(".button-collapse").sideNav();var testgraph={};function runPlayGameTests(){var a=checkValidGraph();""==a?createModule_playGame():(a.push("Continue Anyway?"),myModal.prompt("Graph Tests Failed",a,[],function(a){createModule_playGame()}))}
