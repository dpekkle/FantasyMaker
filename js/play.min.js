...
$.contextMenu({selector:".your-settings-menu",trigger:"left",build:function(a){a={items:{}};a.items.dosomething={name:"do something",callback:function(a,c){alert("Done something")}};return a}});
...
function generic_attributeSelected(a,b){var c="",d="",d=$("#"+a).hasClass("input-field")?c=$("#"+a).closest("div").prop("id"):c=a,e=generic_generateAttributeButton(d,"game-attributes numbers","NO_COL");$("#"+c).replaceWith(e);$("#"+d).children().text(b.name);$("#"+d).attr("path",b.path);updateTooltip(d,b.path)}var hotkeys={},nodes_to_clone;
...
a+")"});$(".playpage").css({"-webkit-transform":"scale("+a+")"})}$(window).resize(resizePlayPage);console.log("Enter main.js version 0.5.0");$(document).ready();$("select").material_select();var testgraph={};function testJumpNodes(){}
