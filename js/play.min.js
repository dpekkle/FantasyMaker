...
"youtube":"error"};this.addAudioEvent=function(a){this.assets[a].addEvent()}}function loadAudioObject(a){var b=new audioObj;b.selected_audio=a.selected_audio;b.unique_id=0;b.loaded=a.loaded;if(0==a.assets.length)b.changed=!1;else{b.changed=!0;for(var c=0;c<a.assets.length;c++)b.addAsset(a.assets[c].name,a.assets[c].link)}return b}var users={};function users_generateNewUser(){return{username:"none",password:"none"}}
...
states={DEFAULT:0,CONNECTING:1,NEWPAGE:2,NEWCONTROL:3};current_state=states.DEFAULT;
...
var observer=new MutationObserver(function(a){a.forEach(function(a){(a.oldvalue="block"==a.target.style.display)&&cy.resize()})}),cytabNode=$("#cyTab")[0],observerConfig={attributes:!0,childList:!1,characterData:!1,attributeOldValue:!0,attributeFilter:["style"]};observer.observe(cytabNode,observerConfig);var pageTemplates={};console.log("enter pageTemplates.js");var selected_page_template=project_project.project_templates.Default;
function createPageTemplate(){var a=prompt("Enter name for page template");if("Default"===a)alert("Can't override Default");else{var b=cy.$(":selected")[0].data();project_project.project_templates[a]=b;$("#pagetemplates").append("<li><a onclick=\"chooseNodeTemplate('"+a+"');\">"+a+"</a></li>")}}
...
function updateTooltip(a,b){for(var c=b.split("_"),d="",e="",f=0;f<c.length;f++){var e=0===f?e+c[0]:e+("_"+c[f]),g=gameAttributes_find(e),d=d+g.name;f!==c.length-1&&(d+=" > ")}$("#"+a).attr("data-tooltip",d);$("#"+a).tooltip({delay:50})}var gameAttributes={};function GameAttribute(a,b,c,d,e,f,g,h){this.name=c;this.is_leaf=e;this.value=f;this.maxValue=h;this.minValue=g;this.parentPath=a;this.id=d;null!=a?(this.level=b+1,this.path=a+"_"+d):(this.path=d,this.level=0);this.childrenArray=[]}
function gameAttributes_addAttribute(a,b,c,d,e){gameAttributes_addChild(a,b,!0,c,d,e)}function gameAttributes_addAttributeFolder(a,b){gameAttributes_addChild(a,b,!1)}
...
function authenticate(a){window.localStorage.setItem("play-token","");return $.ajax({url:"/playAuth",data:{uname:"guest"},cache:!1,type:"POST",success:function(a){console.log("LOGIN RES:");console.log(a);window.localStorage.setItem("play-token",JSON.stringify(a))},contenttype:"application/json"})}function addTokenToHeader(){var a=window.localStorage.getItem("play-token");a&&(a=JSON.parse(a).token,$.ajaxSetup({headers:{"x-access-token":a}}))};
