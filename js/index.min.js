...
($("#profile_button").text(users_getUsername()),projectSettings_prepThenNavToProjects(project_project)))},contenttype:"application/json"})}function http_addTokenToHeader(){var a=window.localStorage.getItem("token");a&&(a=JSON.parse(a).token,$.ajaxSetup({headers:{"x-access-token":a}}))};var indexMain={};$(document).ready();$(".button-collapse").sideNav();var host={},host_location="http://localhost:3000/";function host_create(){return host_location+"create.html"}function host_browse(){return host_location+"browse.html"}function host_play(){return host_location+"play/"}function host_playModule(){return host_location+"play.html"}function host_index(){return host_location+"index.html"};var hotkeys={},nodes_to_clone;
