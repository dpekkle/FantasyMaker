...
!1;this.validated=!0;this.callbackFunction=this.verifyFunction=null;e.html("")}})};this.warning=function(a){$("#promptDesc").css("color","red");!1!==a&&$("#promptDesc").text(a)}}myModal=new myModal;myModal.init();$(document).ready(function(){$("html").on("keydown",function(a){$("#prompt-modal").hasClass("open")&&(13==a.which?myModal.evaluateModal(!0):27==a.which&&myModal.evaluateModal(!1))})});var loginSignup={},loginSignupState=!1;$(document).ready();window.location.href.includes(host_create()&&!window.location.href.includes(host_location+"/play"))||index_autoLogin();
